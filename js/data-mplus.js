...
loot:{s:["iv_aof"],i:[
  ...
  {n:"Coiled Fangstone",ic:"inv_121_trinket_dungeon_ulatek_fangstone",id:273795,sl:"Trinket",b:"Rav'i",p:["Str"],u:"Unleash 3 Envenomed Bites centered on your target, inflicting a total Nature damage split between nearby enemies. Damage increased by 30% per additional enemy, up to 150%. (1 Min Cooldown)",ro:["tank","mdps"],rc:"ig"},
  {n:"Vile Vial of Volatile Venom",ic:"inv_121_trinket_dungeon_ulatek_vile",id:273796,sl:"Trinket",b:"Rav'i",p:["Str","Agi","Int"],u:"Take a small sip of venom, gaining a random secondary stat for 15 sec. Afterwards, a random secondary stat is reduced for 15 sec. (2 Min Cooldown)",ro:["tank","healer","rdps","mdps"],rc:"ig"},
  ...
  {n:"Knot of Writhing Serpents",ic:"inv_121_trinket_dungeon_ulatek_writhe",id:273794,sl:"Trinket",b:"The Writhing Coil",p:["Int"],e:"Your harmful spells have a chance to ensorcell a serpent into spewing venom at your target, inflicting Nature damage split between nearby enemies. Damage increased by 30% per additional enemy, up to 150%. The primary target also suffers an additional Nature damage over 15 sec.",ro:["rdps"],rc:"ig"},
...
{id:"murder-row",name:"Murder Row",short:"Murder Row",map:"mdt-murder-row",banner:"murder-row",sigil:"i-dagger",origin:"Midnight",
 ...
 areas:[
  {n:"The Row",mobs:[
   {n:"Row Hooligan",k:"fodder",a:[
    {n:"Cutpurse",t:["dot"],c:["bleedcl","defensive"],r:["healer"],sev:1,e:"Bleed on a random player.",s:["tk_mr"]}]},
  ...
  {n:"The Warehouse",mobs:[
   {n:"Warehouse Worker",k:"fodder",a:[
    {n:"Sharp Nail",t:["dot"],c:["bleedcl"],r:["healer"],sev:1,e:"Random-target hit and bleed.",h:"Bleeds are everywhere in this dungeon. A cleanse earns its slot here.",s:["tk_mr"]}]},
 ...
 encounters:[
  {n:"Kystia Manaheart",o:1,img:"j-kystia-manaheart",sub:"Burn Nibbles, not the boss",shape:"Three burn windows",lv:2,brief:"A burn-window fight in disguise. She sits behind an 80% damage reduction and cannot be meaningfully hurt until you drain the fel out of Nibbles, who then turns on her — stunning her for twenty seconds at heavily increased damage taken. That window is the fight, three times over, and her shield cap drops with each one. Everything between windows is survival.",a:[
   {n:"Felshield",t:["shield"],c:["focus"],r:["dps"],sev:3,e:"Illicit Infusion keeps Nibbles hostile while she is above 20% health, and Felshield cuts Kystia's damage taken by 80%. Drain the fel from Nibbles and she reverts to her LIGHT form and turns on Kystia: Light Infusion stuns Kystia for 20 seconds, increases all damage she takes by 115%, weakens Felshield, and pulses moderate Chaos damage to the party throughout.",h:"Neither guide explains that Nibbles becomes your ally rather than simply dying. You are not killing a pet, you are freeing one — and the 115% window is where the entire fight happens.",s:["wh_ej","tk_mr","iv_mr"]},
...
loot:{s:["iv_mr"],i:[
  ...
  {n:"Manaheart's Binding Flame",ic:"inv_ember_fel",id:250243,sl:"Trinket",b:"Kystia Manaheart",p:["Str","Agi"],u:"Form a Fel Shield for 10 sec, absorbing 30% of incoming damage. While the shield holds, a portion of the absorbed damage is stored as volatile Fel energy. When the shield expires or breaks, the energy erupts and inflicts Fire damage to split between nearby enemies. (1 Min, 30 Sec Cooldown)",ro:["tank"],rc:"ig"},
  ...
  {n:"Freightrunner's Flask",ic:"inv_alchemy_90_flask_red",id:250215,sl:"Trinket",b:"Zaen Bladesorrow",p:["Agi","Int"],u:"Take a sip of the drink you swiped from the freight, increasing your Critical Strike for 15 sec. (1 Min, 30 Sec Cooldown)",ro:["tank","healer","rdps","mdps"],rc:"ig"},
  ...
  {n:"Resonant Bellowstone",ic:"inv_alchemy_90_stone_green",id:250228,sl:"Trinket",b:"Xathuux the Annihilator",p:["Str","Agi"],e:"Your damaging abilities have a chance to echo with Xathuux's furious roar, increasing your Critical Strike for 30 sec. During this time, each of your attacks increases your Critical Strike by an additional 5, stacking up to a maximum of 5 times. (30s cooldown)",ro:["tank","mdps"],rc:"ig"},
  ...
  {n:"Unstable Felheart Crystal",ic:"tooltip_crystallizedfel",id:250255,sl:"Trinket",b:"Lithiel Cinderfury",p:["Int"],u:"Unleash the fel energy stored within the crystal, sacrificing your health to infuse a target ally for 10 sec, absorbing damage. (2 Min Cooldown)",ro:["healer"],rc:"ig"}]},
 route:[
 ...
 areas:[
  ...
  {n:"The Snowfield",mobs:[
   ...
   {n:"Tar Rumbler",k:"trash",a:[
    {n:"Rumbling Ward",t:["shield","groupdmg"],c:["focus"],r:["dps"],sev:2,e:"Pulses AoE damage for as long as the shield holds.",h:"The faster it breaks, the less the healer eats.",s:["tk_don"]}]},
   ...
   {n:"Glacial Revenant",k:"trash",a:[
    {n:"Cryo Surge",t:["dot","spread"],c:["magic","spread"],r:["healer"],sev:2,e:"Random-target magic damage-over-time that also splashes to nearby players.",h:"Loosely spread on these packs and dispel quickly.",s:["tk_don"]}]},
   ...
   {n:"Winter Squall",k:"mini",a:[
    {n:"Harsh Winter",t:["env","groupdmg"],c:["focus"],r:["dps","healer","tank"],sev:2,e:"Wraps itself in a dense squall cloud that ticks Frost damage on everyone inside. Nothing can be targeted into or out of the cloud, so the fight happens within it. Killing the Squall clears the winds for good.",h:"The targeting rule is the whole mechanic: you have to come inside to hit it, which means the party eats the cloud damage for as long as it lives. Focus it down.",s:["tk_don","wh_dg"]},
    {n:"Cloudpiercer",t:["tankbuster","knockback"],c:["preposition"],r:["tank"],sev:2,e:"A blast of air into its current target for heavy Nature damage and a knockback.",h:"Face it away from the group and stand where being flung back does not put you outside the cloud.",s:["wh_dg"]},
    {n:"Static Discharge",t:["groupdmg","dot"],c:["interrupt"],r:["healer"],sev:2,e:"A cast that showers the whole party in Nature damage every second for several seconds.",h:"Interruptible — kick it. Unkicked it is the bulk of the healing this pack asks for, on top of the cloud.",s:["wh_dg"]}]}]},
...
loot:{s:["iv_don"],i:[
  ...
  {n:"Mycolic Medicine",ic:"inv_misc_starspecklemushroom",id:250248,sl:"Trinket",b:"The Hoardmonger",p:["Int"],e:"You gain Nalorakk's Favor of Growth. Your healing spells and abilities have a chance to instantly heal your target and spawn a glowing mushroom near them that lasts for 10 sec. If an ally steps on and consumes the mushroom, they are healed again.",ro:["healer"],rc:"ig"},
  ...
  {n:"Permafrost Essence",ic:"inv12_jewelrytrinkets_dungeon_permafrostreservoir",id:250244,sl:"Trinket",b:"Sentinel of Winter",e:"You gain Nalorakk's Favor of Enduring. Taking damage has a chance to grant a Mark of Frost, increasing your Critical Strike for 15 sec. Stacks up to 10 times. If your health falls below 25%, the reservoir ruptures, consuming all marks to form a Frost Barrier that absorbs damage per mark for 10 sec.",ro:["tank"],rc:"ig"},
...
{id:"blinding-vale",name:"The Blinding Vale",short:"Blinding Vale",map:"mdt-blinding-vale",banner:"the-blinding-vale",sigil:"i-bloom",origin:"Midnight",
 ...
 encounters:[
  {n:"Lightblossom Trinity",o:1,img:["j-meittik","j-lekshi","j-kezkitt"],sub:"Left path. Meittik, Lekshi and Kezkitt — and they share a health bar",shape:"One phase, shared health bar",lv:2,brief:"Three bosses on a single health bar, which means no target swapping and free cleave. The loop is fixed: Meittik ruptures loam, Lekshi dashes between the patches sowing blossoms, Kezkitt channels a beam into each one — and standing in the beam is what stops it growing. Miss the interceptions and the blossoms return heavily empowered. Simple shape, punishing arithmetic.",a:[
   ...
   {n:"Lightsower Dash",t:["line"],c:["dodge"],r:["dps","healer","tank"],sev:2,e:"Lekshi dashes between the Fertile Loam patches for heavy Holy damage to anyone in the path, sowing a Lightblossom at each destination.",s:["wh_ej"]},
  ...
  {n:"Lightwarden Ruia",o:3,img:"j-lightwarden-ruia",sub:"Three phases by health, then all of them at once",shape:"Three phases, 70% and 40%",lv:3,brief:"Genuinely three-phase, and the odyssey of the dungeon. He opens as a caster dropping silencing Lightfire beams, shifts to bear at 70% for a party bleed that only clears by topping everyone to full, then returns at 40% and channels spirits that cycle all four abilities every eight seconds. The last phase is where it kills — Lightfire landing into Grievous Thrash is the overlap to hold cooldowns for.",a:[
   ...
   {n:"Lightfire",t:["dot","spread","silence"],c:["spread","dodge"],r:["dps","healer"],sev:3,e:"Moderate Radiant damage every second for 6 seconds. On expiry, Lightfire BEAMS emerge at the afflicted player's location — moderate damage per second and a 6-second silence to anyone standing in them.",h:"Both guides describe tornadoes; the journal says beams that persist where you were standing. Move before it expires and leave the beams somewhere nobody needs to walk.",s:["wh_ej","tk_bv"]},
  ...
  {n:"Ziekket",o:4,img:"j-ziekket",sub:"Lashers that do not stay dead",shape:"One phase, no downtime",lv:3,brief:"One phase with no breathing room: Oozing Xylem pulses on the party from pull to kill. Lashers sprout and refuse to die, going dormant rather than dropping, and only a frontal sweep liquifies them — any you leave reawaken immune to crowd control. Meanwhile orbs drift toward him and each one that lands gives a stacking shield and damage buff. Tank on an edge, cleave, sweep, move, repeat.",a:[
   ...
   {n:"Thornspike",t:["tankbuster","dot"],c:["defensive","bleedcl"],r:["tank"],sev:2,e:"Heavy Holy damage, a knockback, and a bleed of moderate damage per second for 10 seconds.",h:"The knockback is not in either guide. Do not take it with your back to the lasher pack.",s:["wh_ej","tk_bv"]}]}],
loot:{s:["iv_bv"],i:[
  ...
  {n:"Seed of Radiant Hope",ic:"inv12_jewelrytrinkets_dungeon_seedofradianthope",id:250254,sl:"Trinket",b:"Lightblossom Trinity",p:["Int"],u:"Surround your target ally with Lightblossoms, healing them over 12 sec. If their health falls below 50%, the Lightblossoms fully bloom in radiant light, instantly healing them. (1 Min, 30 Sec Cooldown)",ro:["healer"],rc:"ig"},
  ...
  {n:"Lightspire Core",ic:"inv_enchant_essenceastrallarge",id:250214,sl:"Trinket",b:"Lightwarden Ruia",p:["Agi","Int"],x:[["Mastery",35]],e:"You are embraced by the Light, increasing Mastery. Your damaging spells and abilities can call a beam of radiant light nearby. Standing in the light blesses you with Mastery while you stand in it.",ro:["tank","healer","rdps","mdps"],rc:"ig"},
  ...
  {n:"Sapling of the Dawnroot",ic:"inv_misc_herb_nightmarevine",id:250259,sl:"Trinket",b:"Ziekket",p:["Str","Agi","Int"],e:"Your spells and abilities have a chance to uproot a Lightspawn Lasher to aid you in combat for 15 sec, dealing Physical damage. The Lightspawn Lasher then withers, bursting into light-infused sap and inflicting Holy damage split among nearby enemies.",ro:["tank","healer","rdps","mdps"],rc:"ig"}]},
 route:[
...
{id:"voidscar-arena",name:"Voidscar Arena",short:"Voidscar",map:"mdt-voidscar-arena",banner:"voidscar-arena",sigil:"i-rift",origin:"Midnight",
 ...
 areas:[
  {n:"The Entrance Halls",mobs:[
   ...
   {n:"Aegyra the Unyielding",k:"mini",a:[
    ...
    {n:"Earthsplitter",t:["denial"],c:["position"],r:["dps","healer","tank"],sev:1,e:"AoE that leaves a large puddle.",h:"If you were the leap target you can bait this towards the outside of the arena.",s:["tk_vsa"]},
   ...
   {n:"Raj'kess the Spellstorm",k:"mini",a:[
    ...
    {n:"Orb of Disruption",t:["totem","debuff"],c:["focus"],r:["dps"],sev:2,e:"Spawns orbs with a long cast. If it completes you get a haste debuff.",h:"Long cast means there is no excuse.",s:["tk_vsa"]},
  ...
  {n:"The Arena Waves",mobs:[
   ...
   {n:"Angry Krul",k:"trash",a:[
    {n:"Violent Sand",t:["groupdmg"],c:["interrupt"],r:["dps"],sev:2,e:"AoE cast.",h:"Have an interrupt ready — it is a one-off mob and easy to forget.",s:["tk_vsa"]}]}]},
 ...
 encounters:[
  {n:"Taz'Rah",o:1,img:"j-tazrah",sub:"Five shades and a shrinking floor",shape:"One phase, shrinking floor",lv:2,brief:"One phase in a room that keeps shrinking. Five shades dash lines through the party and then leave two-minute puddles beneath themselves, so the group stays loosely together, takes the dash as one, and rotates around the arena edge as the floor fills. Dark Bloom later detonates those puddles, which turns a dodge check into a healing check.",a:[
...
loot:{s:["iv_vsa"],i:[
  ...
  {n:"Tumor of the Swarm",ic:"ability_pet_baneling",id:250245,sl:"Trinket",b:"Atroxus",p:["Str","Agi"],e:"Your attacks have a chance to release toxic parasites that burst around you, dealing Nature damage split among nearby enemies and healing you.",ro:["tank"],rc:"ig"},
  ...
  {n:"Mindpiercer's Sigil",ic:"inv_icon_shadowcouncilorb_purple",id:250224,sl:"Trinket",b:"Charonus",e:"Your damaging spells have a chance to stir the Void near your target, erupting Shadow damage split among nearby enemies. You siphon energy from the Void, gaining Intellect for 10 sec.",ro:["rdps","healer"],rc:"ig"}]},
 route:[
...
{id:"kings-rest",name:"King's Rest",short:"King's Rest",map:"mdt-kings-rest",banner:"kings-rest",sigil:"i-tomb",origin:"BfA",
 ...
 encounters:[
  ...
  {n:"The Council of Tribes",o:3,img:["j-akaali","j-kula","j-zanazal"],sub:"Sequential, not simultaneous — and the dead keep interrupting",shape:"Sequential council",lv:3,brief:"Sequential rather than simultaneous, and the dead do not stay quiet. It opens with Kula alone; each defeated councillor returns to their urn and the next joins, but the fallen keep rejoining periodically to fire a single ability. Kula's axes respawn from wherever she died, so kill her in the middle of the room. Zanazal's Explosive Totem is the one cast that reliably ends runs.",a:[
  ...
  {n:"King Dazar",o:4,img:"j-king-dazar",sub:"Two targets on one health bar, under a ceiling that keeps falling",shape:"One phase, mounts at 80%",lv:3,brief:"Two targets sharing one health bar, under a ceiling that keeps falling. Reban joins on pull and should die immediately; T'zala arrives at 80% and Eternal Bond makes cleaving both of them free. Spears rain throughout, and Gilded Destruction adds a flame frontal to his melee swings — so the tank is dodging while keeping him pointed away, which is the hardest positioning in the dungeon.",a:[
   {n:"Impaling Spear",t:["env","dot"],c:["dodge"],r:["dps","healer","tank"],sev:2,e:"Heavy damage within 7 yards of each impact plus a bleed of moderate damage per second for 5 seconds.",s:["wh_ej","tk_kr"]},
   ...
   {n:"T'zala",t:["amp"],c:["focus"],r:["dps"],sev:2,e:"At 80% he mounts her. Eternal Bond makes them share 100% of all damage taken, so cleaving both is genuinely free.",s:["wh_ej","tk_kr"]},
...
loot:{s:["iv_kr"],i:[
  ...
  {n:"Lustrous Golden Plumage",ic:"inv_icon_feather06a",id:159617,sl:"Trinket",b:"The Golden Serpent",p:["Agi"],u:"Your movements shimmer with golden plumage, increasing your Versatility for 20 sec. (2 Min Cooldown)",ro:["tank","mdps"],rc:"ig"},
  ...
  {n:"Mchimba's Ritual Bandages",ic:"inv_misc_emberweavebandagelight",id:159618,sl:"Trinket",b:"Mchimba the Embalmer",p:["Str","Agi"],u:"Wrap yourself in ritual bandages, absorbing damage for 6 sec. (1 Min Cooldown)",ro:["tank"],rc:"ig"},
  ...
  {n:"Stormbound Emblem of Dazar",ic:"inv_7_0raid_necklace_14a",id:273649,sl:"Trinket",b:"King Dazar",p:["Int"],u:"Channel for 2 sec as the wind answers Dazar's command, increasing your Haste up to 20 sec. (2 Min Cooldown)",ro:["rdps","healer"],rc:"ig"}]},
 route:[
...
{id:"ruby-life-pools",name:"Ruby Life Pools",short:"Ruby",map:"mdt-ruby-life-pools",banner:"ruby-life-pools",sigil:"i-egg",origin:"Dragonflight",
 ...
 killers:[
  {n:"Cold Claws at 20 stacks",w:"Infused Whelps. Reaching twenty stacks freezes and stuns the tank. Magic dispels or freedom effects clear them, which makes this a group responsibility rather than a tank one.",s:["tk_rlp"]},
 ...
 encounters:[
  {n:"Melidrussa Chillworn",o:1,img:"j-melidrussa",sub:"Stack, rotate, and break the shield",shape:"Two burn checks, 66% and 33%",lv:2,brief:"Two hard checkpoints in an otherwise steady fight. Hailbombs land permanently and Chillstorm pulls then shoves, so the arena slowly fills and the group rotates as one body. At 66% and 33% she wakes ten whelps and shields herself — the whelps stack toward a stun on the tank while the shield pulses escalating damage. Both are burn checks with a dispel requirement bolted on.",a:[
   ...
   {n:"Awaken Whelps",t:["adds","stacking"],c:["magic","freedom","focus"],r:["tank","healer"],sev:3,e:"At 66% and 33% health she summons ten Infused Whelps, which bring Cold Claws with them.",h:"Tank picks them up fast and the group watches the stack count — twenty means a stunned tank in the middle of the next mechanic.",s:["tk_rlp"]},
  ...
  {n:"Kyrakka and Erkhart Stormvein",o:3,img:["j-kyrakka","j-erkhart-stormvein"],sub:"Predictable winds, if you learn the order",shape:"Two phases, joins at 40%",lv:3,brief:"Two phases. Kyrakka circles overhead while Erkhart intercepts on the ground, and when either of them reaches 40% she lands so he can remount. Winds of Change is the mechanic that decides it: the hurricane shoves both players and Kyrakka's fire in one of four directions, and the order is fixed — so puddles can be placed deliberately to be blown away from the group rather than through it.",a:[
   ...
   {n:"Interrupting Cloudburst",t:["silence"],c:["position"],r:["dps","healer"],sev:1,t:["silence","groupdmg","myth"],e:"significant Nature damage to everyone and interrupts casts for 2 seconds.",h:"Stop casting when you see it.",s:["wh_ej","tk_rlp"]}]}],
loot:{s:["iv_rlp"],i:[
  ...
  {n:"Ruby Whelp Shell",ic:"inv_item_dragonegg_redbroken01",id:193757,sl:"Trinket",b:"Melidrussa Chillworn",p:["Str","Agi","Int"],u:"Call your Ruby Whelpling to inspect your target's situation, teaching them how to be helpful. (1 Day Cooldown)",e:"Your spells and abilities have a chance to call a Ruby Whelpling, which will try to be helpful and assist you in combat.",ro:["tank","healer","rdps","mdps"],rc:"ig"},
  {n:"Havoc Crusher",ic:"inv_mace_1h_dragondungeon_c_02",id:193767,sl:"One-hand",ty:"Mace",b:"Ko'kia Blazehoof",p:["Agi"],x:[["Crit",7],["Haste",4]]},
  {n:"Blazebound Lieutenant's Helm",ic:"inv_mail_dragondungeon_c_01_helm",id:193765,sl:"Head",ty:"Mail",b:"Ko'kia Blazehoof",p:["Agi","Int"],x:[["Mastery",14],["Vers",8]]},
  {n:"Fireproof Drape",ic:"inv_mail_dragondungeon_c_01_cape",id:193763,sl:"Back",ty:"Cloak",b:"Ko'kia Blazehoof",p:["Str","Agi","Int"],x:[["Haste",8],["Crit",4]]},
  {n:"Invader's Firestorm Chestguard",ic:"inv_leather_dragondungeon_c_01_chest",id:193764,sl:"Chest",ty:"Leather",b:"Ko'kia Blazehoof",p:["Agi","Int"],x:[["Mastery",13],["Vers",8]]},
  {n:"Kokia's Burnout Rod",ic:"inv_offhand_1h_drakonid_c_01",id:193766,sl:"Off-hand",ty:"Off-hand",b:"Ko'kia Blazehoof",p:["Int"],x:[["Crit",7],["Vers",4]]},
  {n:"Blazebinder's Hoof",ic:"inv_10_dungeonjewelry_primalist_trinket_2_fire",id:193762,sl:"Trinket",b:"Ko'kia Blazehoof",x:[["Haste",15]],u:"Bind with the blaze for 20 sec, giving your attacks a high chance to increase your Strength, stacking up to 6 times. When your binding is complete, emit a burnout wave, dealing Fire damage split between all nearby enemies, based on the strength of your binding. (500ms cooldown) (2 Min Cooldown)",ro:["tank","mdps"],es:["Str"],rc:"ig"},
  ...
  {n:"Kyrakka's Searing Embers",ic:"inv_10_dungeonjewelry_primalist_trinket_4_fire",id:193748,sl:"Trinket",b:"Kyrakka and Erkhart Stormvein",x:[["Crit",15]],e:"Your helpful spells and abilities have a high chance to create a Burning Ember on an ally. The ember flares up after 1 sec, cauterizing wounds to heal and expelling Fire damage split between nearby enemies. (1s cooldown)",ro:["healer"],rc:"ig"}]},
 route:[
  ...
  {n:7,t:"Ko'kia",m:"Boss",d:2,p:"Drop fire towards the mini-boss you did not pull, then move in the opposite direction.",s:["tk_rt"]},
...
{id:"temple-of-sethraliss",name:"Temple of Sethraliss",short:"Sethraliss",map:"mdt-temple-of-sethraliss",banner:"temple-of-sethraliss",sigil:"i-serpent",origin:"BfA",
 ...
 killers:[
  ...
  {n:"Corruption",w:"Avatar of Sethraliss. Soaking Corrupted Lifeforce reduces healing done and increases physical damage taken — which is why it must be two DPS, staggered, and never the tank or healer.",s:["tk_tos"]},
 ...
 areas:[
  ...
  {n:"The Serpent Halls",mobs:[
   {n:"Sand Sworn Rider",k:"trash",a:[
    {n:"Swarming Krolusks",t:["adds"],c:["focus"],r:["dps"],sev:2,e:"Spawns two Krolusk adds that bring the Serrated Charge bleed with them.",h:"Cleave them down fast rather than letting the bleeds accumulate.",s:["tk_tos"]},
    {n:"Scouring Sand",t:["frontal"],c:["dodge"],r:["dps","healer"],sev:1,e:"Random-target frontal.",h:"Play close enough to the mob that stepping out is easy.",s:["tk_tos"]}]},
   ...
   {n:"Lightning Serpent",k:"trash",a:[
    {n:"Serpent's Stormcall",t:["amp","denial"],c:["defensive"],r:["tank"],sev:2,e:"Buff increasing their damage to the tank, dropping a puddle when it expires.",s:["tk_tos"]}]},
 ...
 encounters:[
  ...
  {n:"Merektha",o:2,img:"j-merektha",sub:"Boss phase, add phase, repeat",shape:"Boss and add phase alternation",lv:2,brief:"A clean alternation. She fights, then at full energy burrows through the floor while the chamber shakes and her eggs hatch into vipers and a storm serpent. Clear the adds, she returns, repeat. A Knot of Snakes is the coordination point — it locks a player out of the fight entirely until the knot is destroyed or crowd controlled, and an arrow marks who is about to be caught.",a:[
  ...
  {n:"Galvazzt",o:3,img:"j-galvazzt",sub:"Three spires, and a soak that hurts to take",shape:"One phase, energy race",lv:3,brief:"An energy race with a body cost. Spires form and beam power into him, and the only way to stop it is to stand in the beam — which carries a 250% increase to physical damage taken for as long as you hold it. He also bleeds energy passively, so a clean interception phase can stop Consume Charge outright. Rotate who blocks, and never let the tank hold a beam into a melee swing.",a:[
   {n:"Lightning Spire",t:["soak","groupdmg"],c:["soak","position"],r:["dps","healer","tank"],sev:3,e:"Spires form from lightning strikes that deal very heavy damage within 5 yards and knock back. Each then energises him unless a player blocks the connection and becomes Galvanized. He passively loses energy over time, so blocking buys real ground.",h:"Mythic creates multiple spires. The passive energy decay means a clean intercept phase can stop Consume Charge entirely.",s:["wh_ej","tk_tos"]},
   {n:"Consume Charge",t:["groupdmg","amp","debuff"],c:["soak"],r:["dps","healer","tank"],sev:3,e:"Heavy Nature damage to everyone and a 50% reduction in party damage done for 20 seconds — plus a stack of Capacitance, permanently raising his damage by 25%.",s:["wh_ej","tk_tos"]},
  ...
  {n:"Avatar of Sethraliss",o:4,img:"j-avatar-of-sethraliss",sub:"A trash fight that ends when the boss is healed to full",shape:"Two stages, healing objective",lv:3,brief:"Not a damage fight at all — you win by restoring her to full health, and it runs in two stages. First, Essence Defilers block all external healing while Corrupted Guardians drop Life Force orbs that two DPS soak in strict alternation, because the debuff cuts healing done and multiplies physical damage taken. Then the taint lifts, tormentors fixate the healer, and you push each to 25% so she siphons them. Unusual, and it punishes improvisation.",a:[
...
loot:{s:["wh_dg"],i:[
  ...
  {n:"Merektha's Fang",ic:"inv_misc_food_87_sporelingsnack",id:158367,sl:"Trinket",b:"Merektha",p:["Str"],u:"Pump the fang's noxious venom gland, spraying poisonous mist forward in a cone. The mist deals Nature damage every 1 sec over 3 sec, stacking up to 3 times. (2 Min Cooldown)",ro:["tank","mdps"],rc:"ig"},
  ...
  {n:"Tiny Electromental in a Jar",ic:"inv_alchemy_71_potion4",id:158374,sl:"Trinket",b:"Galvazzt",p:["Agi"],e:"Your attacks and abilities have a chance to grant Phenomenal Power. On reaching 12 applications you will Unleash Lightning, inflicting Nature damage. \"Phenomenal lightning power, itty bitty containment space.\"",ro:["mdps"],rc:"ig"},
