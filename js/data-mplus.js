...
loot:{s:["iv_aof"],i:[
  ...
  {n:"Vile Vial of Volatile Venom",ic:"inv_121_trinket_dungeon_ulatek_vile",id:273796,sl:"Trinket",b:"Rav'i",p:["Str","Agi","Int"],u:"Take a small sip of venom, gaining a random secondary stat for 15 sec. Afterwards, a random secondary stat is reduced for 15 sec. (2 Min Cooldown)",ro:["tank","healer","rdps","mdps"]},
  ...
  {n:"Knot of Writhing Serpents",ic:"inv_121_trinket_dungeon_ulatek_writhe",id:273794,sl:"Trinket",b:"The Writhing Coil",p:["Int"],e:"Your harmful spells have a chance to ensorcell a serpent into spewing venom at your target, inflicting Nature damage split between nearby enemies. Damage increased by 30% per additional enemy, up to 150%. The primary target also suffers an additional Nature damage over 15 sec.",ro:["rdps"]},
...
loot:{s:["iv_mr"],i:[
  ...
  {n:"Unstable Felheart Crystal",ic:"tooltip_crystallizedfel",id:250255,sl:"Trinket",b:"Lithiel Cinderfury",p:["Int"],u:"Unleash the fel energy stored within the crystal, sacrificing your health to infuse a target ally for 10 sec, absorbing damage. (2 Min Cooldown)",ro:["healer"]}]},
 route:[
...
loot:{s:["iv_don"],i:[
  ...
  {n:"Mycolic Medicine",ic:"inv_misc_starspecklemushroom",id:250248,sl:"Trinket",b:"The Hoardmonger",p:["Int"],e:"You gain Nalorakk's Favor of Growth. Your healing spells and abilities have a chance to instantly heal your target and spawn a glowing mushroom near them that lasts for 10 sec. If an ally steps on and consumes the mushroom, they are healed again.",ro:["healer"]},
...
loot:{s:["iv_bv"],i:[
  ...
  {n:"Seed of Radiant Hope",ic:"inv12_jewelrytrinkets_dungeon_seedofradianthope",id:250254,sl:"Trinket",b:"Lightblossom Trinity",p:["Int"],u:"Surround your target ally with Lightblossoms, healing them over 12 sec. If their health falls below 50%, the Lightblossoms fully bloom in radiant light, instantly healing them. (1 Min, 30 Sec Cooldown)",ro:["healer"]},
...
loot:{s:["iv_vsa"],i:[
  ...
  {n:"Tumor of the Swarm",ic:"ability_pet_baneling",id:250245,sl:"Trinket",b:"Atroxus",p:["Str","Agi"],e:"Your attacks have a chance to release toxic parasites that burst around you, dealing Nature damage split among nearby enemies and healing you.",ro:["mdps"]},
  ...
  {n:"Mindpiercer's Sigil",ic:"inv_icon_shadowcouncilorb_purple",id:250224,sl:"Trinket",b:"Charonus",e:"Your damaging spells have a chance to stir the Void near your target, erupting Shadow damage split among nearby enemies. You siphon energy from the Void, gaining Intellect for 10 sec.",ro:["rdps"]}]},
 route:[
...
loot:{s:["iv_kr"],i:[
  ...
  {n:"Lustrous Golden Plumage",ic:"inv_icon_feather06a",id:159617,sl:"Trinket",b:"The Golden Serpent",p:["Agi"],u:"Your movements shimmer with golden plumage, increasing your Versatility for 20 sec. (2 Min Cooldown)",ro:["mdps"]},
  ...
  {n:"Mchimba's Ritual Bandages",ic:"inv_misc_emberweavebandagelight",id:159618,sl:"Trinket",b:"Mchimba the Embalmer",p:["Str","Agi"],u:"Wrap yourself in ritual bandages, absorbing damage for 6 sec. (1 Min Cooldown)",ro:["tank"]},
  ...
  {n:"Stormbound Emblem of Dazar",ic:"inv_7_0raid_necklace_14a",id:273649,sl:"Trinket",b:"King Dazar",p:["Int"],u:"Channel for 2 sec as the wind answers Dazar's command, increasing your Haste up to 20 sec. (2 Min Cooldown)",ro:["rdps","healer"]}]},
 route:[
...
loot:{s:["iv_rlp"],i:[
  ...
  {n:"Kyrakka's Searing Embers",ic:"inv_10_dungeonjewelry_primalist_trinket_4_fire",id:193748,sl:"Trinket",b:"Kyrakka and Erkhart Stormvein",x:[["Crit",15]],e:"Your helpful spells and abilities have a high chance to create a Burning Ember on an ally. The ember flares up after 1 sec, cauterizing wounds to heal and expelling Fire damage split between nearby enemies. (1s cooldown)",ro:["healer"]}]},
 route:[
...
loot:{s:["wh_dg"],i:[
  ...
  {n:"Merektha's Fang",ic:"inv_misc_food_87_sporelingsnack",id:158367,sl:"Trinket",b:"Merektha",p:["Str"],u:"Pump the fang's noxious venom gland, spraying poisonous mist forward in a cone. The mist deals Nature damage every 1 sec over 3 sec, stacking up to 3 times. (2 Min Cooldown)",ro:["mdps"]},
  ...
  {n:"Tiny Electromental in a Jar",ic:"inv_alchemy_71_potion4",id:158374,sl:"Trinket",b:"Galvazzt",p:["Agi"],e:"Your attacks and abilities have a chance to grant Phenomenal Power. On reaching 12 applications you will Unleash Lightning, inflicting Nature damage. \"Phenomenal lightning power, itty bitty containment space.\"",ro:["mdps"]},
